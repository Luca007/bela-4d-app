    ...
    <section>
      ...
      <div class="dash-card pad">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-bottom:16px;align-items:center;">
          ...
          <label class="dash-chip dash-chip-chroma" style="position:relative;width:40px;height:40px;padding:0;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;border:3px solid ${!PROFILE_COLORS.includes(dash.profileAvatar.color) ? dash.profileAvatar.color : 'transparent'};background:conic-gradient(from 0deg,#ff0033,#ff8800,#ffee00,#26ff00,#00ffe1,#0066ff,#9900ff,#ff0077,#ff0033);flex-shrink:0;">
